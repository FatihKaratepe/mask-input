...
import { IMask, InputMask } from 'mfk-mask-input';
...
function App() {
  ...
  return (
    <>
      <a
        href="https://github.com/FatihKaratepe/mfk-mask-input"
          ...
          <Col span={24}>
            <Card title="Only Number">
              <Row gutter={[15, 15]}>
                <Col span={24}>
                  <h3>Only Number</h3>
                  <InputMask mask={Number} placeholder="You can enter only numbers" />
                </Col>
                <Col span={24}>
                  <h3>Only Number (max: 35)</h3>
                  <InputMask
                    mask={Number}
                    maskOptions={{ max: 35 } as never}
            ...
            <Card title="Date">
              <InputMask
                ...
                maskOptions={{
                  ...
                  parse: (str: string) => {
                    const [year, month, day] = str.split('-').map((a: string) => Number(a));
